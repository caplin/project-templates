...
1. In your IDE, create a run configuration for the main class of your project:
    ...
    **Note**: IDEs on Microsoft Windows will not recognise the symlink in the path above. Instead, use the path <code><em>dfw_location</em>\\kits\\<em>adapter_name</em>\\<em>adapter_name-version</em>\\DataSource</code>
