...
This template project provides a starting point for writing pricing integration adapters based on Caplin's [Java DataSource API](http://www.caplin.com/developer/api/datasource_java/latest/).
